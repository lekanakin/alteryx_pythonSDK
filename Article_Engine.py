...
class IncomingInterface:
    ...
    def ii_update_progress(self, d_percent: float):
        ...
        self.parent.alteryx_engine.output_tool_progress(self.parent.n_tool_id,
                                                        d_percent)  # Inform the Alteryx engine of the tool's progress.
    ...
    def ii_close(self):
        ...
        self.parent.output_anchor.output_record_count(
            True)  # True: Let Alteryx engine know that all records have been sent downstream.
